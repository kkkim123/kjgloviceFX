    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employment_status', models.CharField(blank=True, choices=[('', 'Please Choose...'), ('1', 'Employed'), ('2', 'Self-Employed'), ('3', 'Unemployed'), ('4', 'Retired'), ('5', 'Student')], default='1', max_length=1, null=True)),
                ('industry', models.CharField(blank=True, max_length=256, null=True)),
                ('employment_position', models.CharField(blank=True, choices=[('', 'Please Choose...'), ('1', 'Senior level Management'), ('2', 'Middle Management'), ('3', 'Entry Level')], default='1', max_length=1, null=True)),
                ('education_level', models.CharField(blank=True, choices=[('', 'Please Choose...'), ('1', 'Bachelors Degree or Equivalent'), ('2', 'Masters Degree or equivalent'), ('3', 'Phd / Research Degree'), ('4', 'Diploma or Equivalent')], default='1', max_length=1, null=True)),
                ('annual_income', models.CharField(blank=True, choices=[('', 'Please Choose...'), ('1', 'Less Than 10,000'), ('2', '10,000 to 50,000'), ('3', '50,000 to 100,000'), ('4', 'Over 100,000')], default='1', max_length=1, null=True, verbose_name='annual income')),
                ('income_source', models.CharField(blank=True, choices=[('', 'Please Choose...'), ('1', 'Employed'), ('2', 'Self-Employed'), ('3', 'Unemployed'), ('4', 'Retired'), ('5', 'Student')], default='1', max_length=1, null=True, verbose_name='income source')),
                ('expected_deposit', models.CharField(blank=True, choices=[('', 'Please Choose...'), ('1', 'Employed'), ('2', 'Self-Employed'), ('3', 'Unemployed'), ('4', 'Retired'), ('5', 'Student')], default='1', max_length=1, null=True, verbose_name='expected deposit')),
                ('trading_experience', models.CharField(blank=True, choices=[('', 'Please Choose...'), ('1', 'Y'), ('2', 'N')], default='1', max_length=1, null=True, verbose_name='trading experience')),
                ('trading_period', models.CharField(blank=True, choices=[('', 'Please Choose...'), ('1', 'I have a relevant education/professional qualification'), ('2', 'I regularly monitor the news/markets'), ('3', 'I have read educational material on FX trading'), ('4', 'all of the above'), ('5', 'none of above')], default='1', max_length=1, null=True, verbose_name='trading period')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_idx', models.IntegerField(blank=True, default=0, null=True)),
