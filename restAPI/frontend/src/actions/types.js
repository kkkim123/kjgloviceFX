...
//파트너 유저 조회
export const PART_LOADED = 'PART_LOADED';
//파트너 계좌 조회
export const PART_ACCOUNT = 'PART_ACCOUNT';
//모든 파트너 수수료 조회
export const PARTS_COMMISION = 'PARTS_COMMISION';
//일부 파트너 수수료 조회
export const PART_COMMISION = 'PART_COMMISION';
//deposit 요청, 조회
