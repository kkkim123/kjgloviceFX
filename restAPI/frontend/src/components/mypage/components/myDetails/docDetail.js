    ...
    return (
      <div className="container">
        <div className="row">
          <span>ID 앞</span>
          <img
            src={this.props.file && this.props.file.doc_photo_id}
          ...
          <Dropzone
            ...
            submitButtonDisabled={
              this.props.auth.user && this.props.auth.user.user_status >= 6
            }
          />
        </div>
        <div className="row">
        ...
        <div className="row">
          <span>ID 뒤</span>
          <img
            src={this.props.file && this.props.file.doc_photo_id_2}
            style={{ maxHeight: 300, maxWidth: 300 }}
          />
          <Dropzone
        ...
        <div className="row">
          <span>
            ...
            {this.props.file &&
              Moment(this.props.file.updated_at).format("YYYY-MM-DD HH:mm:ss")}
          </span>
        </div>
      </div>
    );
